...
<div class="navbar custom-navbar navbar-fixed-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <!-- lOGO TEXT HERE -->
            <a href="loginResult.jsp" class="navbar-brand" style="color:white">CA-登录结果</a>
        </div>
...
<section id="home">
    <div class="container">
        <%
            try {
                ...
                if (conn != null) {
                    ...
                    if (!IdCardVerification.IDCardValidate(userid).equals("该身份证有效！")) {%>
        <tr>
            <div align="center">
        ...
        <tr>
            <div align="center">
                <h2 class="wow fadeInUp" data-wow-delay="0.6s" style="color:white">登录失败，该身份证还没有被注册</h2>
                <h3 class="wow fadeInUp" data-wow-delay="0.6s" style="color:white">请从点击确认返回</h3>
                <form action="login.html" method="post">
                    <div align="center"><button type="submit">确认</button></div>
                </form>
        ...
        <%
            ...
            if (check_pwd.equals((rs.getString("password")))) {
                //request.getSession().setAttribute("userid",rsa.encryptByPrivateKey(userid));
        %>
        <tr>
            <div align="center">
                <h2 class="wow fadeInUp" data-wow-delay="0.6s" style="color:white">登录成功</h2>
                <h3 class="wow fadeInUp" data-wow-delay="0.6s" style="color:white">请从点击确认进入功能菜单</h3>
                <%
                    System.out.println("loginresult:userid="+userid);
