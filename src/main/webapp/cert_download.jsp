...
<%
    ...
    System.out.println("cert_download:userid=" + userid);
...
<div class="navbar custom-navbar navbar-fixed-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <!-- lOGO TEXT HERE -->
            <a href="cert_download.jsp" class="navbar-brand" style="color:white">CA-下载证书</a>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div align="center">
                ...
                <h2 class="wow fadeInUp" data-wow-delay="0.6s" style="color:white"> 点击下载证书或下载CA证书</h2>
                <p style="color:white">注：若没有注册证书,则下载无效</p>
            </div>
            <div align="center">
                <a href="DownLoadServlet">
                    <button style="width:150px;height:60px;margin:60px">下载证书</button>
                </a>
                <a href="DownloadCACertServlet">
                    <button style="width:150px;height:60px;margin:60px">下载CA证书</button>
                </a>
                <%--<a href="DownLoadServlet">下载证书</a> <br/>
                <a href="DownloadCACertServlet">下载CA证书</a> <br/>--%>
            </div>
        </div>
    </div>
</section>
